...
architecture Behavioral of bk_detector is
		...
		signal sig_flag4 : std_logic := '0';										--10110111000
...
begin
	...
	variable countnum1 : integer := 0;	
	variable countnum2 : integer := 0;
	variable countnum3 : integer := 0;
	variable countnum4 : integer := 0;	
	...
	begin
		if(rst = '1' or ctl='1') then
			...
			--if(bkdata(51)='1' and bkdata(47)='0' and bkdata(43)='1' and bkdata(39)='0' and  bkdata(35)='1' and bkdata(31)='1' and bkdata(27)='0' and
			--bkdata(23)='0' and bkdata(19)='1' and bkdata(15)='1' and bkdata(11)='1' and bkdata(7)='1' and bkdata(3)='1' ) then
			--	sig_flag1 <= '1';   --1111100110101
			--end if ;
			--if(bkdata(50)='1' and bkdata(46)='0' and bkdata(42)='1' and bkdata(38)='0' and  bkdata(34)='1' and bkdata(30)='1' and bkdata(26)='0' and
			--bkdata(22)='0' and bkdata(18)='1' and bkdata(14)='1' and bkdata(10)='1' and bkdata(6)='1' and bkdata(2)='1' ) then
			--	sig_flag2 <= '1';
			--end if ;
			--if(bkdata(49)='1' and bkdata(45)='0' and bkdata(41)='1' and bkdata(37)='0' and  bkdata(33)='1' and bkdata(29)='1' and bkdata(25)='0' and
			--bkdata(21)='0' and bkdata(17)='1' and bkdata(13)='1' and bkdata(9)='1' and bkdata(5)='1' and bkdata(1)='1' ) then
			--	sig_flag3 <= '1';
			--end if ;
			--if(bkdata(48)='1' and bkdata(44)='0' and bkdata(40)='1' and bkdata(36)='0' and  bkdata(32)='1' and bkdata(28)='1' and bkdata(24)='0' and
			--bkdata(20)='0' and bkdata(16)='1' and bkdata(12)='1' and bkdata(8)='1' and bkdata(4)='1' and bkdata(0)='1' ) then
			--	sig_flag4 <= '1';
			--end if ;
