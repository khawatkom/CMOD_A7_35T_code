...
HD_PWD='E:/Vivado2017/VivadoProjects/CMOD_A7_35T_code/CMOD_A7_SECOND_EDITION/CMOD_A7_SECOND_EDITION.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SSB.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SSB.tcl
