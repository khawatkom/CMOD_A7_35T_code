...
HD_PWD='E:/Vivado2017/VivadoProjects/CMOD_A7_SECOND_EDITION/CMOD_A7_SECOND_EDITION.runs/clknew4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clknew4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clknew4.tcl
