...
HD_PWD='E:/Vivado2017/VivadoProjects/CMOD_A7_SECOND_EDITION/CMOD_A7_SECOND_EDITION.runs/rom224_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom224.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom224.tcl
